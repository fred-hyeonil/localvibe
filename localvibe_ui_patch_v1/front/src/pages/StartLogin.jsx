        ...
        <div className="auth-card">
          ...
          <button className="auth-google-btn">
            <svg width="18" height="18" viewBox="0 0 48 48" style={{ flexShrink: 0 }}>
              <path fill="#4285F4" d="M44.5 20H24v8.5h11.8C34.5 33.5 29.8 37 24 37c-7.2 0-13-5.8-13-13s5.8-13 13-13c3.1 0 5.9 1.1 8.1 2.9l6-6C34.5 5.1 29.5 3 24 3 12.4 3 3 12.4 3 24s9.4 21 21 21c10.5 0 20-7.6 20-21 0-1.3-.2-2.7-.5-4z"/>
          ...
          <div className="auth-form">
            ...
            <button className="auth-submit-btn">로그인</button>
          </div>

          <p className="auth-switch">
            계정이 없으신가요?{" "}
            <a href="/signin" className="auth-switch-link">회원가입</a>
          </p>
        </div>
      </div>
    </div>
